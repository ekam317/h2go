...
@push('css')
    <link href="{{asset('plugins/components/tablesaw-master/dist/tablesaw.css')}}" rel="stylesheet">
@endpush
            ...
            <div class="col-lg-12">
                <div class="white-box">
                    ...
                    <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe"
                        ...
                        <tr>
                            <td class="title"><a href="javascript:void(0)">Harry Potter and the Deathly Hallows—Part
                                    2</a></td>
                            <td>4</td>
                            <td>2011</td>
                            <td>96%</td>
                        ...
                        <tr>
                            <td class="title"><a href="javascript:void(0)">The Lord of the Rings: The Return of the
                                    King</a></td>
                            <td>8</td>
                            <td>2003</td>
                            <td>95%</td>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="white-box">
                    ...
                    <p class="text-muted m-b-20">The Column Toggle Table allows the user to select which columns they
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="white-box">
                    ...
                    <p class="text-muted m-b-20">The Column Swipe Table allows the user to select which columns they
                        want to be visible.</p>
                    <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe">
                        <thead>
                        <tr>
...
@push('js')
    <script src="{{asset('plugins/components/tablesaw-master/dist/tablesaw.js')}}"></script>
    <script src="{{asset('plugins/components/tablesaw-master/dist/tablesaw-init.js')}}"></script>
@endpush
