...
@push('js')
    ...
    <script src="{{asset('plugins/components/tiny-editable/mindmup-editabletable.js')}}"></script>
    <script src="{{asset('plugins/components/tiny-editable/numeric-input-example.js')}}"></script>
    <script>
