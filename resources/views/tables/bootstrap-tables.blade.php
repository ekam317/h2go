...
@push('css')
    <link href="{{asset('plugins/components/bootstrap-table/dist/bootstrap-table.min.css')}}" rel="stylesheet" type="text/css" />
@endpush
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="white-box">
                    ...
                    <table data-toggle="table" data-url="http://themedesigner.in/demo/myadmin/myadmin/components/bootstrap-table/bootstrap-test.json" data-click-to-select="true" data-select-item-name="myRadioName" data-height="295">
                        <thead>
                        <tr>
            ...
            <div class="col-sm-6">
                <div class="white-box">
                    ...
                    <table data-toggle="table" data-url="http://themedesigner.in/demo/myadmin/myadmin/components/bootstrap-table/bootstrap-test.json" data-click-to-select="true" data-height="295">
                        <thead>
                        <tr>
...
@push('js')
    <script src="{{asset('plugins/components/bootstrap-table/dist/bootstrap-table.min.js')}}"></script>
    <script src="{{asset('plugins/components/bootstrap-table/dist/bootstrap-table.ints.js')}}"></script>
@endpush
