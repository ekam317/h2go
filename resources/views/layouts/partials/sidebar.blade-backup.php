        ...
        @if(auth()->check())
            ...
            <nav class="sidebar-nav">
                <ul id="side-menu">
                    ...
                    @endcan
                    <li>
                        <a class="waves-effect" href="{{ url('serviceprovider') }}">
                        <img src=" https://png.icons8.com/cotton/25/000000/speedometer.png">
                            <span class="hide-menu"> Dashboard</span>
                        </a>
                    </li>
                <li>
                    <li>
                            <a class="waves-effect" href="{{ url('serviceprovider/profile') }}">
                            <img src="https://png.icons8.com/cotton/25/000000/doctors-bag.png">
                                <span class="hide-menu"> Profile</span>
                            </a>
                        </li>
                    <li>
                        <a class="waves-effect" href="{{ url('serviceprovider/identityinformation') }}">
                        <img src="https://png.icons8.com/cotton/25/000000/doctors-folder.png">
                            <span class="hide-menu"> Identity Information</span>
                        </a>
                    </li>
                    <li>
                        <a class="waves-effect" href="{{ url('serviceprovider/degrees') }}">
                        <img src="https://png.icons8.com/cotton/25/000000/doctors-bag.png">
                            <span class="hide-menu"> Medical Education</span>
                        </a>
                    </li>
                    <li>
                        <a class="waves-effect" href="{{ url('serviceprovider/saudi') }}">
                        <img src="https://png.icons8.com/cotton/25/000000/receipt-approved.png">
                            <span class="hide-menu"> Saudi Commission</span>
                        </a>
                    </li>
                    <li>
                        <a class="waves-effect" href="{{ url('serviceprovider/academicteaching') }}">
                        <img src="https://png.icons8.com/cotton/25/000000/transaction-approved.png">
                            <span class="hide-menu"> Academic Teaching</span>
                        </a>
                    </li>
                    <li>
                        <a class="waves-effect" href="{{ url('serviceprovider/paymenttransaction') }}">
                        <img src="https://png.icons8.com/cotton/25/000000/transaction-approved.png">
                            <span class="hide-menu"> Profile Transactions</span>
                        </a>
                    </li>
                    <li>
                        <a class="waves-effect" href="{{ url('serviceprovider/paymentmethods') }}">
                        <img src="https://png.icons8.com/cotton/25/000000/receipt-approved.png">
                    ...
                    <li>
                        ...
                        <img src="https://png.icons8.com/cotton/25/000000/fishing-pole.png">
                            <span class="hide-menu"> Account Settings</span>
                        </a>
                    </li>
                    <li>
                        <a class="waves-effect" href="{{ url('contracts') }}">
                        <img src="https://png.icons8.com/cotton/25/000000/test-partial-passed.png">
                            <span class="hide-menu"> Contracts</span>
                        </a>
                    </li>
                    <li>
                        <a class="waves-effect" href="{{ url('serviceprovider/urgentrequest1') }}">
                        <img src="https://png.icons8.com/cotton/25/000000/test-partial-passed.png">
                            <span class="hide-menu"> Urgent Request</span>
                        </a>
                    </li>
                    @if(auth()->user()->isAdmin() == true)
                        <li>
                        ...
                        <li class="two-column">
                            <a class="waves-effect" href="javascript:void(0);" aria-expanded="false"><i
                                        class="icon-equalizer fa-fw"></i> <span
