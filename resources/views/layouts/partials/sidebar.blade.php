    ...
    <div class="scroll-sidebar">
        ...
        @if(auth()->check())
            ...
            <nav class="sidebar-nav">
                ...
                <li>
                    <li>
                        <a class="waves-effect" href="{{ url('serviceprovider/identityinformation') }}"style="background-color:#fff;">
                        <img src="https://png.icons8.com/cotton/25/000000/doctors-folder.png">
                        <span class="hide-menu"> Identity Information</span>
                        </a>
                    </li> 
                    <li>
                        <a class="waves-effect" href="{{ url('serviceprovider/degrees') }}"style="background-color:#fff;">
                        <img src="https://png.icons8.com/cotton/25/000000/doctors-bag.png">
                            <span class="hide-menu"> Medical Education</span>
                        </a>
                    </li>
                    <li> 
                        <a class="waves-effect" href="{{ url('serviceprovider/saudi') }}"style="background-color:#fff;">
                        <img src="https://png.icons8.com/cotton/25/000000/receipt-approved.png">
                            <span class="hide-menu"> Saudi Commission</span>
                        </a>
                    </li>
                    <li>
                        <a class="waves-effect" href="{{ url('serviceprovider/academicteaching') }}"style="background-color:#fff;">
                        <img src="https://png.icons8.com/cotton/25/000000/transaction-approved.png">
                            <span class="hide-menu"> Academic Teaching</span>
                        </a>
                   </li>
                    <li>
                        <a class="waves-effect" href="{{ url('serviceprovider/paymenttransaction') }}"style="background-color:#fff;">
                        <img src="https://png.icons8.com/cotton/25/000000/transaction-approved.png">
                            <span class="hide-menu"> Profile Transactions</span>
                        </a>
                   </li>
                    <li>
                        <a class="waves-effect" href="{{ url('serviceprovider/paymentmethods') }}"style="background-color:#fff;">
                        <img src="https://png.icons8.com/cotton/25/000000/receipt-approved.png">
                            <span class="hide-menu"> Payment Method</span>
                        </a>
                    </li>
                    <li>
                        <a class="waves-effect" href="{{ url('account-settings') }}"style="background-color:#fff;">
