<div class="form-group {{ $errors->has('board_type') ? 'has-error' : ''}}">
    {!! Form::label('board_type', 'Board Type', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::text('board_type', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
        {!! $errors->first('board_type', '<p class="help-block">:message</p>') !!}
    </div>
    ...
    <div class="col-md-6">
        {!! Form::text('attachment', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
