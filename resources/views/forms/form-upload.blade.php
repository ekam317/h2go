        ...
        <div class="row">
            ...
            <div class="col-sm-6 ol-md-6 col-xs-12">
                <div class="white-box">
                    ...
                    <input type="file" id="input-file-now-custom-1" class="dropify" data-default-file="plugins/components/dropify/src/images/test-image-1.jpg" /> </div>
            </div>
        </div>
        <!-- /.row -->
        <div class="row">
            ...
            <div class="col-sm-6 ol-md-6 col-xs-12">
                <div class="white-box">
                    ...
                    <input type="file" id="input-file-now-custom-3" class="dropify" data-height="500" data-default-file="plugins/components/dropify/src/images/test-image-2.jpg" /> </div>
            </div>
        </div>
        <!-- .row -->
        <div class="row">
