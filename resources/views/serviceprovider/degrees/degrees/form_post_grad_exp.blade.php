...
<div> <h5><strong>Clinical Fellowship</strong> <img src="https://png.icons8.com/cotton/30/000000/doctors-folder.png"> </h5></div>
<div class="form-group {{ $errors->has('health_institution_name') ? 'has-error' : ''}}">
    {!! Form::label('health_institution_name', 'Country', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('medical_education_level') ? 'has-error' : ''}}">
    {!! Form::label('medical_education_level', 'Number of Years', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
...
<div> <h5><strong>Residency Training</strong> <img src="https://png.icons8.com/cotton/30/000000/doctors-folder.png"></h5></div>
<div class="form-group {{ $errors->has('health_institution_name') ? 'has-error' : ''}}">
    {!! Form::label('health_institution_name', 'Country', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::text('health_institution_name', $degree->health_institution_name, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
...
<div> <h5><strong>Research Fellowship</strong> <img src="https://png.icons8.com/cotton/30/000000/doctors-folder.png"></h5></div>
<div class="form-group {{ $errors->has('health_institution_name') ? 'has-error' : ''}}">
    {!! Form::label('health_institution_name', 'Country', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::text('health_institution_name', $degree->health_institution_name, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
