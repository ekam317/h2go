        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="white-box">
                    ...
                    <h2>**** **** **** 2150</h2> <span class="pull-right">Expiry date: 10/16</span> <span
                            class="font-500">Jon Doe</span></div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="white-box">
            ...
            <div class="col-md-12 col-xs-12">
                <div class="white-box">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#iprofile" aria-controls="profile" role="tab"
                                                                  data-toggle="tab" aria-expanded="false"><span><i
                                            class="fa fa-credit-card"></i></span> Debit Card</a></li>
                        <li role="presentation" class=""><a href="#ihome" aria-controls="home" role="tab"
                                                            data-toggle="tab" aria-expanded="true"><span><i
                                            class="fa fa-cc-paypal text-info"></i></span> Paypal</a></li>
                    </ul>
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane " id="ihome"> You can pay your money through paypal, for
                        ...
                        <div role="tabpanel" class="tab-pane active" id="iprofile">
                            ...
                            <div class="col-md-4 col-sm-5 pull-right">
                                ...
                                <h2><i class="fa fa-cc-visa text-info"></i> <i
                                            class="fa fa-cc-mastercard text-danger"></i> <i
                                            class="fa fa-cc-discover text-success"></i> <i
                                            class="fa fa-cc-amex text-warning"></i></h2>
