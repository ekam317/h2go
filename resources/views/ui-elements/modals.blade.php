...
@section('content')
    <div class="container-fluid1111">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="white-box">
                    <h3 class="box-title">Large model
                    ...
                    <!-- /.modal -->
                    <!-- Button trigger modal --><img src="plugins/images/model2.png" alt="default" data-toggle="modal"
                                                      data-target=".bs-example-modal-lg"
                                                      class="model_img img-responsive"/></div>
            </div>
            <div class="col-md-4">
                <div class="white-box">
                    <h3 class="box-title">Medium model
                        <small>Click on image</small>
                    </h3>
                    <!-- sample modal content -->
                    ...
                    <!-- /.modal -->
                    <!-- Button trigger modal --><img src="plugins/images/model.png" alt="default" data-toggle="modal"
                                                      data-target="#myModal" class="model_img img-responsive"/></div>
            </div>
            <div class="col-md-4">
                <div class="white-box">
                    <h3 class="box-title">Small model
                        <small>Click on image</small>
                    </h3>
                    <!-- sample modal content -->
                    ...
                    <!-- /.modal -->
                    <!-- Button trigger modal --><img src="plugins/images/model3.png" alt="default" data-toggle="modal"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-danger waves-effect waves-light">Save changes
                                    </button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <img src="plugins/images/model.png" alt="default" data-toggle="modal"
