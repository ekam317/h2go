        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="white-box">
                    ...
                    <p class="text-muted m-b-30">Use a classes <code>btn btn-default</code>to quickly create a General
                        btn.</p>
                    <div class="row">
                    ...
                    <p class="text-muted m-b-30">Use a classes <code>btn btn-default disabled</code>to quickly create a
                        Disabled btn.</p>
                    <div class="row">
                        <div class="col-lg-2 col-sm-4 col-xs-12">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="white-box">
                    ...
                    <p class="text-muted m-b-30">Use a classes <code>btn btn-default btn-outline</code>to quickly create
                        a Outline btn.</p>
                    <div class="row">
                        <div class="col-lg-2 col-sm-4 col-xs-12">
                    ...
                    <p class="text-muted m-b-30">Use a classes <code>btn btn-default btn-rounded</code>to quickly create
                        a Rounded btn.</p>
                    <div class="row">
                        <div class="col-lg-2 col-sm-4 col-xs-12">
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-6 col-xs-12">
                <div class="white-box">
                    ...
                    <p class="text-muted m-b-30">Use a class <code>btn-lg</code> <code>btn-sm</code> <code>btn-xs</code>
                    </p>
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6 col-xs-12">
                <div class="white-box">
                    ...
                    <div class="button-box">
                        <button class="btn btn-outline btn-default waves-effect waves-light"><i
                                    class="fa fa-heart m-r-5"></i> <span>Love</span></button>
                        <button class="btn btn-info waves-effect waves-light"><span>Love</span> <i
                                    class="fa fa-heart m-l-5"></i></button>
                        <button class="btn btn-success waves-effect waves-light" type="button"><span
                                    class="btn-label"><i class="fa fa-check"></i></span>Success
                        </button>
                        <button class="btn btn-primary btn-rounded waves-effect waves-light" type="button"><span
                                    class="btn-label"><i class="fa fa-envelope-o"></i></span>Mail
                        </button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="button-box">
                        <div class="btn-group m-r-10">
                            <button aria-expanded="false" data-toggle="dropdown"
                                    class="btn btn-info dropdown-toggle waves-effect waves-light" type="button">Dropdown
                        ...
                        <div class="btn-group dropup m-r-10">
                            <button aria-expanded="false" data-toggle="dropdown"
                                    class="btn btn-danger dropdown-toggle waves-effect waves-light" type="button">
                        ...
                        <div class="btn-group m-r-10">
                            <button aria-expanded="false" data-toggle="dropdown"
                                    ...
                                    type="button"><i class="fa fa-heart m-r-5"></i> <span class="caret"></span></button>
                            <ul role="menu" class="dropdown-menu">
                                <li><a href="#">Action</a></li>
                                <li><a href="#">Another action</a></li>
                                <li><a href="#">Something else here</a></li>
                        ...
                        <div class="btn-group dropup">
                            <button aria-expanded="false" data-toggle="dropdown"
                                    class="btn btn-warning dropdown-toggle waves-effect waves-light" type="button"><i
                                        class="fa fa-heart m-r-5"></i> <span class="caret"></span></button>
                            <ul role="menu" class="dropdown-menu">
                                <li><a href="#">Action</a></li>
                                <li><a href="#">Another action</a></li>
                                <li><a href="#">Something else here</a></li>
                ...
                <div class="white-box">
                    ...
                    <div class="button-box">
                        <div class="fileupload btn btn-info waves-effect waves-light"><span><i
                                        class="ion-upload m-r-5"></i>Upload</span>
                            <input type="file" class="upload"></div>
                        <div class="fileupload btn btn-danger btn-rounded waves-effect waves-light"><span><i
                                        class="ion-upload m-r-5"></i>Upload</span>
                            <input type="file" class="upload"></div>
                        <div class="fileupload btn btn-default btn-outline btn-rounded waves-effect waves-light">
                            <span><i class="ion-upload m-r-5"></i>Upload</span>
                            <input type="file" class="upload"></div>
                        <div class="fileupload btn btn-default btn-outline waves-effect waves-light"><span><i
                                        class="ion-upload m-r-5"></i>Upload</span>
                            <input type="file" class="upload"></div>
                    </div>
                </div>
                    ...
                    <div class="button-box">
                        <div class="button-list">
                            ...
                            <button class="btn btn-youtube waves-effect btn-circle waves-light" type="button"><i
                                        class="fa fa-youtube"></i></button>
                            <h3 class="m-t-20">With Rounded <code class="font-12">btn btn-facebook btn-rounded</code>
                            </h3>
                            ...
                            <button class="btn btn-twitter waves-effect btn-rounded waves-light" type="button"><i
                                        class="fa fa-twitter"></i></button>
                            <button class="btn btn-googleplus waves-effect btn-rounded waves-light" type="button"><i
                                        class="fa fa-google-plus"></i></button>
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-12">
                <div class="white-box">
                    ...
                    <div class="button-box">
                        <p class="text-muted m-b-30">Give class to the button <code>fcbtn btn btn-outline btn-primary
                                btn-1b</code></p>
            ...
            <div class="col-lg-6 col-sm-6 col-xs-12">
                <div class="white-box">
                    ...
                    <div class="btn-group btn-group-justified m-b-20"><a
                                class="btn btn-default btn-outline waves-effect waves-light" role="button">Left</a> <a
                                class="btn btn-default btn-outline waves-effect waves-light" role="button">Middle</a> <a
                                class="btn btn-default btn-outline waves-effect waves-light" role="button">Right</a>
                    </div>
                    <div class="btn-group">
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="white-box">
                    <div class="button-box">
                        ...
                        <div class="btn-group m-r-10">
                            <button aria-expanded="false" data-toggle="dropdown"
                                    class="btn btn-info dropdown-toggle waves-effect waves-light" type="button">Flipinx
                                <span class="caret"></span></button>
                        ...
                        <div class="btn-group dropdown m-r-10">
                            <button aria-expanded="false" data-toggle="dropdown"
                                    class="btn btn-danger dropdown-toggle waves-effect waves-light" type="button">
                                Flipiny <span class="caret"></span></button>
                        ...
                        <div class="btn-group m-r-10">
                            <button aria-expanded="false" data-toggle="dropdown"
                                    class="btn btn-default btn-outline dropdown-toggle waves-effect waves-light"
                                    type="button"> LightSpeedIn <span class="caret"></span></button>
                        ...
                        <div class="btn-group dropdown">
                            <button aria-expanded="false" data-toggle="dropdown"
                                    class="btn btn-warning dropdown-toggle waves-effect waves-light" type="button">
                                Slideinup <span class="caret"></span></button>
