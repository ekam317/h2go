...
@push('css')
    <link rel="stylesheet" href="{{asset('plugins/components/html5-editor/bootstrap-wysihtml5.css')}}"/>
    <!-- Dropzone css -->
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-md-3  col-sm-4 col-xs-12 inbox-panel">
                            <div><a href="#" class="btn btn-custom btn-block waves-effect waves-light">Compose</a>
                                <div class="list-group mail-list m-t-20"><a href="inbox.html"
                                                                            class="list-group-item active">Inbox
                                        <span class="label label-rouded label-success pull-right">5</span></a> <a
                                ...
                                <div class="list-group b-0 mail-list"><a href="#" class="list-group-item"><span
                                                ...
                                                class="fa fa-circle text-warning m-r-10"></span>Family</a> <a
                                            href="#" class="list-group-item"><span
                                                class="fa fa-circle text-purple m-r-10"></span>Private</a> <a
                                            href="#" class="list-group-item"><span
                                                class="fa fa-circle text-danger m-r-10"></span>Friends</a> <a
                                            href="#" class="list-group-item"><span
...
@push('js')
    <script src="{{asset('plugins/components/html5-editor/wysihtml5-0.3.0.js')}}"></script>
    <script src="{{asset('plugins/components/html5-editor/bootstrap-wysihtml5.js')}}"></script>
