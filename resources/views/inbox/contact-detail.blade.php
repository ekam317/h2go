    ...
    <div class="container-fluid1111">
        <div class="row">
            <div class="col-md-4 col-xs-12">
                <div class="white-box">
                    <div class="user-bg"><img width="100%" alt="user" src="{{asset(
                    'plugins/images/large/img1.jpg')}}"></div>
                ...
                <div class="white-box">
                    ...
                    <ul class="nav nav-tabs tabs customtab">
                        ...
                        <li class="tab">
                            <a href="#profile" data-toggle="tab"> <span class="visible-xs"><i
                                            class="fa fa-user"></i></span> <span class="hidden-xs">Profile</span>
                            </a>
                        </li>
                        <li class="tab">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="home">
                            <div class="steamline">
                                <div class="sl-item">
                                    <div class="sl-left"><img src="{{asset('plugins/images/users/1.jpg')}}" alt="user"
                                                              class="img-circle"/></div>
                                    <div class="sl-right">
                                        <div class="m-l-40"><a href="#" class="text-info">John Doe</a> <span
                                                    class="sl-date">5 minutes ago</span>
                                            <p>assign a new task <a href="#"> Design weblayout</a></p>
                                            <div class="m-t-20 row"><img src="{{asset('plugins/images/img1.jpg')}}" alt="user"
                                                                         class="col-md-3 col-xs-12"/> <img
                                                        src="{{asset('plugins/images/img2.jpg')}}" alt="user"
                                                        class="col-md-3 col-xs-12"/> <img
                                                        src="{{asset('plugins/images/img3.jpg')}}" alt="user"
                                ...
                                <hr>
                                <div class="sl-item">
                                    <div class="sl-left"><img src="{{asset('plugins/images/users/2.jpg')}}" alt="user"
                                                              class="img-circle"/></div>
                                    <div class="sl-right">
                                        <div class="m-l-40"><a href="#" class="text-info">John Doe</a> <span
                                                    class="sl-date">5 minutes ago</span>
                                            <div class="m-t-20 row">
                                                <div class="col-md-2 col-xs-12"><img src="{{asset('plugins/images/img1.jpg')}}"
                                                                                     alt="user"
                                ...
                                <hr>
                                <div class="sl-item">
                                    <div class="sl-left"><img src="{{asset('plugins/images/users/3.jpg')}}" alt="user"
                                                              class="img-circle"/></div>
                                    <div class="sl-right">
                                        <div class="m-l-40"><a href="#" class="text-info">John Doe</a> <span
                                                    class="sl-date">5 minutes ago</span>
                                ...
                                <hr>
                                <div class="sl-item">
                                    <div class="sl-left"><img src="{{asset('plugins/images/users/4.jpg"')}}" alt="user"
                                                              class="img-circle"/></div>
                                    <div class="sl-right">
                                        <div class="m-l-40"><a href="#" class="text-info">John Doe</a> <span
                                                    class="sl-date">5 minutes ago</span>
